...
# direct methods
.method constructor <init>(Lhez;Lhfi;Lhes;Lcom/google/android/gms/signin/internal/SignInResponse;)V
    .locals 0

    iput-object p1, p0, Lhfa;->c:Lhez;

    iput-object p3, p0, Lhfa;->a:Lhes;

    iput-object p4, p0, Lhfa;->b:Lcom/google/android/gms/signin/internal/SignInResponse;
...
.method public a()V
    ...
    iget-object v1, p0, Lhfa;->b:Lcom/google/android/gms/signin/internal/SignInResponse;

    .line 2000
    const/4 v2, 0x0

    invoke-virtual {v0, v2}, Lhes;->b(I)Z
    ...
    invoke-virtual {v0, v2}, Lhes;->b(Lcom/google/android/gms/common/ConnectionResult;)V
    ...
    iput-boolean v2, v0, Lhes;->g:Z

    invoke-virtual {v1}, Lcom/google/android/gms/common/internal/ResolveAccountResponse;->a()Lgwp;

    move-result-object v2

    iput-object v2, v0, Lhes;->h:Lgwp;

    invoke-virtual {v1}, Lcom/google/android/gms/common/internal/ResolveAccountResponse;->c()Z

    move-result v2

    iput-boolean v2, v0, Lhes;->i:Z

    invoke-virtual {v1}, Lcom/google/android/gms/common/internal/ResolveAccountResponse;->d()Z

    move-result v1

    iput-boolean v1, v0, Lhes;->j:Z
    ...
    :cond_2
    invoke-virtual {v0, v2}, Lhes;->a(Lcom/google/android/gms/common/ConnectionResult;)Z
