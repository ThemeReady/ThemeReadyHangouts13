...
.method public constructor <init>(Ljava/io/InputStream;Laqy;)V
    .locals 1
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->c:Laqy;

    .line 98
    new-instance v0, Lawu;

    invoke-direct {v0, p1}, Lawu;-><init>(Ljava/io/InputStream;)V

    iput-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lawt;

    .line 99
    return-void
.end method

.method public constructor <init>(Ljava/nio/ByteBuffer;Laqy;)V
    .locals 1
    ...
    invoke-direct {v0, p1}, Lawr;-><init>(Ljava/nio/ByteBuffer;)V
...
.method private static a(Laws;)I
    .locals 10
    ...
    .line 286
    invoke-virtual {p0, v1}, Laws;->b(I)S
    ...
    .line 299
    :goto_0
    invoke-virtual {p0, v0}, Laws;->a(Ljava/nio/ByteOrder;)V

    .line 301
    const/16 v0, 0xa

    invoke-virtual {p0, v0}, Laws;->a(I)I
    ...
    .line 307
    invoke-virtual {p0, v3}, Laws;->b(I)S
    ...
    invoke-virtual {p0, v5}, Laws;->b(I)S
    ...
    invoke-virtual {p0, v6}, Laws;->a(I)I
...
.method private d()I
    ...
    .line 244
    :cond_0
    iget-object v1, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lawt;

    invoke-interface {v1}, Lawt;->b()S
    ...
    .line 267
    iget-object v3, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lawt;

    int-to-long v4, v1

    invoke-interface {v3, v4, v5}, Lawt;->a(J)J
...
.method public b()Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser$ImageType;
    ...
    .line 114
    iget-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lawt;

    invoke-interface {v0}, Lawt;->a()I
    ...
    invoke-interface {v0, v2, v3}, Lawt;->a(J)J

    .line 127
    iget-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lawt;

    invoke-interface {v0}, Lawt;->c()I
    ...
    invoke-interface {v0, v6, v7}, Lawt;->a(J)J
...
.method public c()I
    ...
    .line 191
    iget-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->c:Laqy;

    const-class v3, [B

    invoke-virtual {v0, v2, v3}, Laqy;->a(ILjava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-interface {v3, v0, v2}, Lawt;->a([BI)I
    ...
    :cond_4
    :goto_2
    iget-object v2, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->c:Laqy;

    const-class v3, [B

    invoke-virtual {v2, v0, v3}, Laqy;->a(Ljava/lang/Object;Ljava/lang/Class;)V
    ...
    invoke-direct {v1, v0, v2}, Laws;-><init>([BI)V

    invoke-static {v1}, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->a(Laws;)I
    :try_end_1
