...
.method public a(Lbko;Ljava/util/List;)V
    .locals 12
    ...
    .line 85
    iget-object v1, v4, Ledk;->a:Ledq;

    .line 1168
    sget-object v2, Lgoi;->a:[I
    ...
    .line 91
    :cond_2
    iget-object v1, v4, Ledk;->h:Ljava/lang/String;

    if-eqz v1, :cond_7

    iget-object v1, v4, Ledk;->f:Ljava/lang/String;

    if-nez v1, :cond_3

    iget-object v1, v4, Ledk;->e:Ljava/lang/String;
    ...
    iget-object v2, v4, Ledk;->h:Ljava/lang/String;

    const/4 v3, 0x0

    iget-object v4, v4, Ledk;->f:Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, v2, p1}, Lcom/google/android/apps/hangouts/views/AvatarView;->a(Ljava/lang/String;ZLbko;)V

    goto :goto_5

    .line 99
    :cond_8
    iget-object v1, v4, Ledk;->b:Ledo;

    invoke-virtual {v0, v1, p1}, Lcom/google/android/apps/hangouts/views/AvatarView;->a(Ledo;Lbko;)V
    ...
    .line 125
    :cond_12
    invoke-static {v3, v8}, Lgwb;->a([Ljava/lang/String;I)Ljava/lang/CharSequence;
