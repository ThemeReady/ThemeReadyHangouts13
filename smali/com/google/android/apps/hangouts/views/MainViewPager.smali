...
# static fields
.field public static final d:Lgoy;

.field public static final e:Lgoy;


# instance fields
.field private f:Lgoz;
...
.method static constructor <clinit>()V
    ...
    invoke-direct/range {v0 .. v5}, Lgoy;-><init>(Ljava/lang/Class;Ljava/lang/String;III)V

    sput-object v0, Lcom/google/android/apps/hangouts/views/MainViewPager;->d:Lgoy;
    ...
    sput-object v0, Lcom/google/android/apps/hangouts/views/MainViewPager;->e:Lgoy;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .prologue
    .line 46
    invoke-direct {p0, p1, p2}, Lgow;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method private a(Led;Ljava/util/List;Ljava/util/List;)V
    .locals 7
    ...
    .line 141
    :cond_3
    iget-object v1, p0, Lcom/google/android/apps/hangouts/views/MainViewPager;->f:Lgoz;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    move-result-object v4

    invoke-virtual {v1, v4}, Lgoz;->a(Ljava/lang/Class;)Z
    ...
    .line 165
    :cond_6
    invoke-virtual {v2}, Lew;->b()I

    .line 168
    invoke-virtual {p1}, Led;->b()Z
...
.method public a(ILed;Z)Z
    ...
    invoke-virtual {p2}, Led;->d()Ljava/util/List;
    ...
    invoke-direct/range {v0 .. v5}, Lgoz;-><init>(Led;Landroid/content/Context;ILjava/util/List;I)V

    .line 91
    iput-object v0, p0, Lcom/google/android/apps/hangouts/views/MainViewPager;->f:Lgoz;

    .line 92
    iget-object v0, p0, Lcom/google/android/apps/hangouts/views/MainViewPager;->f:Lgoz;

    invoke-virtual {p0, v0}, Lcom/google/android/apps/hangouts/views/MainViewPager;->a(Lnp;)V
    ...
    .line 95
    invoke-direct {p0, p2, v6, v0}, Lcom/google/android/apps/hangouts/views/MainViewPager;->a(Led;Ljava/util/List;Ljava/util/List;)V
...
.method public i()Lgoy;
    ...
    invoke-virtual {v1, v0}, Lgoz;->d(I)Lgoy;
