...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Ljwu;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method private a(Landroid/os/Bundle;)V
    ...
    .line 168
    :cond_1
    invoke-virtual {p0}, Lcom/google/android/libraries/social/settings/PreferenceScreen;->B()Ljwy;

    move-result-object v0

    invoke-virtual {v0, v4}, Ljwy;->a(Landroid/content/DialogInterface;)V
...
.method private i()Landroid/widget/ListAdapter;
    ...
    invoke-direct {v0, p0}, Ljwv;-><init>(Ljwu;)V
...
.method protected a(Landroid/os/Parcelable;)V
    ...
    .line 218
    :cond_0
    invoke-super {p0, p1}, Ljwu;->a(Landroid/os/Parcelable;)V
    ...
    .line 223
    invoke-virtual {p1}, Ljxe;->getSuperState()Landroid/os/Parcelable;

    move-result-object v0

    invoke-super {p0, v0}, Ljwu;->a(Landroid/os/Parcelable;)V

    .line 224
    iget-boolean v0, p1, Ljxe;->a:Z

    if-eqz v0, :cond_1

    .line 225
    iget-object v0, p1, Ljxe;->b:Landroid/os/Bundle;
...
.method protected e()Landroid/os/Parcelable;
    ...
    .prologue
    .line 202
    invoke-super {p0}, Ljwu;->e()Landroid/os/Parcelable;
    ...
    invoke-direct {v0, v1}, Ljxe;-><init>(Landroid/os/Parcelable;)V
    ...
    iput-object v1, v0, Ljxe;->b:Landroid/os/Bundle;
...
.method public onDismiss(Landroid/content/DialogInterface;)V
    ...
    invoke-virtual {v0, p1}, Ljwy;->b(Landroid/content/DialogInterface;)V
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    .line 192
    invoke-virtual {v0, p0}, Ljwi;->a(Lcom/google/android/libraries/social/settings/PreferenceScreen;)V
