...
.method constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    .line 47
    iput-object p1, p0, Laat;->b:Landroid/widget/ProgressBar;
...
.method private a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Lji;->a()Landroid/graphics/drawable/Drawable;
    ...
    .line 75
    invoke-direct {p0, v0, p2}, Laat;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0, v1}, Lji;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_2
    invoke-direct {p0, v6, v0}, Laat;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 99
    iget-object v0, p0, Laat;->c:Landroid/graphics/Bitmap;

    if-nez v0, :cond_7

    .line 100
    iput-object v1, p0, Laat;->c:Landroid/graphics/Bitmap;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 51
    iget-object v0, p0, Laat;->b:Landroid/widget/ProgressBar;

    invoke-virtual {v0}, Landroid/widget/ProgressBar;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, Laat;->a:[I

    invoke-static {v0, p1, v1, p2, v3}, Lafp;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lafp;

    move-result-object v4

    .line 54
    invoke-virtual {v4, v3}, Lafp;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 56
    iget-object v5, p0, Laat;->b:Landroid/widget/ProgressBar;
    ...
    invoke-direct {p0, v7, v9}, Laat;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 59
    :cond_2
    invoke-virtual {v4, v9}, Lafp;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 61
    iget-object v1, p0, Laat;->b:Landroid/widget/ProgressBar;

    invoke-direct {p0, v0, v3}, Laat;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
