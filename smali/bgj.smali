...
.field private transient e:Lblo;
...
.method constructor <init>(IJLjava/util/List;)V
    ...
    .line 49
    iput-wide p2, p0, Lbgj;->b:J

    .line 50
    iput-object p4, p0, Lbgj;->c:Ljava/util/List;
...
.method public a(Landroid/content/Context;Lbhb;)I
    ...
    invoke-virtual {v2}, Lblo;->v()Ljava/util/List;
    ...
    iget-object v2, v0, Lbgj;->c:Ljava/util/List;
    ...
    .line 95
    invoke-static {v2}, Lfde;->e(Lbko;)Lfdn;
    ...
    invoke-virtual {v2, v15, v3}, Lfdn;->a(Ljava/util/Collection;I)V

    .line 98
    const-string v2, "babel_call_media_type_refresh_log_delay_ms"

    sget-wide v4, Lfls;->x:J
    ...
    invoke-direct {v3, v6, v4, v5, v0}, Lbgk;-><init>(IJLjava/util/List;)V
    ...
    .line 106
    invoke-static {v2, v3, v6}, Lglk;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
