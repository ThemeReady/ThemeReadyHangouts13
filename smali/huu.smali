...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lhuu;->o:[Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Lhus;ZILandroid/os/Bundle;Landroid/os/Bundle;Ljava/lang/String;)V
    ...
    invoke-direct/range {v0 .. v7}, Lhuo;-><init>(Landroid/content/Context;Lhus;ZILandroid/os/Bundle;Landroid/os/Bundle;Ljava/lang/String;)V

    iput-object p7, p0, Lhuu;->p:Ljava/lang/String;
...
.method protected a(Lhur;Lhur;Landroid/database/Cursor;)Lhug;
    ...
    iget-object v3, p0, Lhuu;->i:Lhwg;

    const-string v4, "people-map start"

    invoke-virtual {v3, v4}, Lhwg;->a(Ljava/lang/String;)V

    invoke-static {p1, v2}, Lhuu;->a(Lhur;Ljava/util/HashMap;)V
    ...
    invoke-direct {v4}, Lhvh;-><init>()V

    new-instance v8, Ljava/util/HashMap;

    invoke-direct {v8}, Ljava/util/HashMap;-><init>()V

    invoke-virtual {p0, p2, v8}, Lhuu;->b(Lhur;Ljava/util/HashMap;)V

    iget-object v7, p0, Lhuu;->i:Lhwg;

    const-string v9, "contact-map start"

    invoke-virtual {v7, v9}, Lhwg;->a(Ljava/lang/String;)V

    invoke-virtual {p0, p3, v3, v4, v8}, Lhuu;->a(Landroid/database/Cursor;Lhwi;Lhvh;Ljava/util/HashMap;)I

    move-result v7

    iget-object v9, p0, Lhuu;->i:Lhwg;

    const-string v10, "contact-map finish"

    invoke-virtual {v9, v10}, Lhwg;->a(Ljava/lang/String;)V
    ...
    invoke-static {v9, v0}, Lgwb;->i(Ljava/lang/String;Ljava/lang/String;)V

    :cond_0
    iget-object v0, p0, Lhuu;->i:Lhwg;

    const-string v7, "merge start"

    invoke-virtual {v0, v7}, Lhwg;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v9}, Lhur;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v9

    invoke-virtual {v5, v0}, Lhvi;->a(I)V

    invoke-virtual {v7, v9}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    if-eqz v9, :cond_1

    invoke-virtual {v3, v9}, Lhwi;->a(Ljava/lang/String;)I
    ...
    :cond_2
    invoke-virtual {v6, v3, v9}, Lhvi;->a(Lhwi;Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v3}, Lhvh;->a(I)I
    ...
    invoke-virtual {v6, v3}, Lhvi;->a(I)V
    ...
    invoke-virtual {v4, v3, v0}, Lhvh;->a(II)Ljava/lang/String;
    ...
    iget-object v3, p0, Lhuu;->a:Landroid/content/Context;
    ...
    iget-object v10, p0, Lhuu;->f:Landroid/os/Bundle;
...
.method protected c()Landroid/database/Cursor;
    ...
    sget-object v0, Lhum;->b:Landroid/net/Uri;

    invoke-virtual {v0}, Landroid/net/Uri;->buildUpon()Landroid/net/Uri$Builder;

    move-result-object v0

    iget-object v1, p0, Lhuu;->p:Ljava/lang/String;
    ...
    iget-object v0, p0, Lhuu;->a:Landroid/content/Context;
    ...
    invoke-direct {v8}, Lhwf;-><init>()V

    iget-boolean v0, p0, Lhuu;->c:Z

    iget-object v1, p0, Lhuu;->a:Landroid/content/Context;

    invoke-static {v8, v0, v1}, Lhul;->a(Lhwf;ZLandroid/content/Context;)V

    invoke-static {v8}, Lhul;->a(Lhwf;)V
    ...
    sget-object v2, Lhuu;->o:[Ljava/lang/String;
    ...
    invoke-direct {v1, v9, v10}, Lhuv;-><init>(Landroid/database/Cursor;I)V

    new-instance v2, Lhuv;

    invoke-direct {v2, v0, v10}, Lhuv;-><init>(Landroid/database/Cursor;I)V
    ...
    invoke-virtual {v8, v0}, Lhwf;->b(Ljava/lang/String;)V
    ...
    invoke-virtual {v8, v0}, Lhwf;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v8}, Lhwf;->toString()Ljava/lang/String;
