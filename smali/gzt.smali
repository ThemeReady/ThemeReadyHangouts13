...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lgzt;->b:Landroid/content/Context;

    return-void
.end method

.method static declared-synchronized a(Landroid/content/Context;)Lgzt;
    .locals 2
...
.method private b(Landroid/os/Bundle;)Landroid/app/PendingIntent;
    ...
    invoke-static {p1, v0}, Lgzt;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v1, p0, Lgzt;->b:Landroid/content/Context;
    ...
    invoke-static {v0}, Lgzc;->b(Landroid/os/Bundle;)V
...
.method private b(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p2}, Lgzt;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v4, p0, Lgzt;->b:Landroid/content/Context;
    ...
    :goto_2
    invoke-static {v0}, Lgzt;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method a(Landroid/os/Bundle;)Z
    ...
    invoke-direct {p0, p1, v0}, Lgzt;->b(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v7, p0, Lgzt;->b:Landroid/content/Context;
    ...
    .line 1000
    :goto_1
    invoke-direct {p0, p1}, Lgzt;->b(Landroid/os/Bundle;)Landroid/app/PendingIntent;

    move-result-object v7

    new-instance v8, Lfx;

    iget-object v9, p0, Lgzt;->b:Landroid/content/Context;

    invoke-direct {v8, v9}, Lfx;-><init>(Landroid/content/Context;)V

    const/4 v9, 0x1

    invoke-virtual {v8, v9}, Lfx;->e(Z)Lfx;

    move-result-object v8

    invoke-virtual {v8, v3}, Lfx;->a(I)Lfx;
    ...
    invoke-virtual {v3, v4}, Lfx;->a(Ljava/lang/CharSequence;)Lfx;
    ...
    invoke-virtual {v3, v5}, Lfx;->b(Ljava/lang/CharSequence;)Lfx;
    ...
    invoke-virtual {v3, v4}, Lfx;->e(I)Lfx;

    :cond_1
    if-eqz v0, :cond_2

    invoke-virtual {v3, v0}, Lfx;->a(Landroid/net/Uri;)Lfx;

    :cond_2
    if-eqz v7, :cond_3

    invoke-virtual {v3, v7}, Lfx;->a(Landroid/app/PendingIntent;)Lfx;

    :cond_3
    invoke-virtual {v3}, Lfx;->b()Landroid/app/Notification;
    ...
    iget-object v8, p0, Lgzt;->b:Landroid/content/Context;
    ...
    invoke-virtual {v3, v4}, Lfx;->a(Ljava/lang/CharSequence;)Lfx;
    :try_end_0
    .catch Lgzu; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v0}, Lgzu;->getMessage()Ljava/lang/String;
