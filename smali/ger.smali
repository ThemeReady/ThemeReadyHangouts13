...
.method private constructor <init>(Landroid/telecom/PhoneAccountHandle;Landroid/telecom/RemoteConference;Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;)V
    ...
    iput-object v0, p0, Lger;->c:Landroid/telecom/RemoteConference$Callback;

    .line 50
    iput-object p2, p0, Lger;->a:Landroid/telecom/RemoteConference;

    .line 51
    iput-object p3, p0, Lger;->b:Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;
    ...
    invoke-virtual {p0, v0}, Lger;->setConnectionCapabilities(I)V
    ...
    invoke-virtual {p0, v0}, Lger;->a(I)V

    .line 54
    iget-object v0, p0, Lger;->c:Landroid/telecom/RemoteConference$Callback;
    ...
    .line 56
    invoke-static {v0, p3}, Lgel;->a(Landroid/telecom/RemoteConnection;Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;)Lgcq;
    ...
    .line 59
    invoke-virtual {p0, v2}, Lger;->addConnection(Landroid/telecom/Connection;)Z
...
.method public static a(Landroid/telecom/RemoteConference;Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;)Lger;
    .locals 5
    ...
    .line 33
    invoke-static {v0, p1}, Lgel;->a(Landroid/telecom/RemoteConnection;Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;)Lgcq;
    ...
    invoke-direct {v1, v0, p0, p1}, Lger;-><init>(Landroid/telecom/PhoneAccountHandle;Landroid/telecom/RemoteConference;Lcom/google/android/apps/hangouts/telephony/TeleConnectionService;)V
...
.method a(I)V
    ...
    .line 138
    :pswitch_1
    invoke-virtual {p0}, Lger;->setOnHold()V

    goto :goto_0

    .line 141
    :pswitch_2
    invoke-virtual {p0}, Lger;->setActive()V
...
.method public onAudioStateChanged(Landroid/telecom/AudioState;)V
    ...
    .line 129
    iget-object v0, p0, Lger;->a:Landroid/telecom/RemoteConference;
...
.method public onSeparate(Landroid/telecom/Connection;)V
    ...
    .line 83
    instance-of v1, v0, Lgel;

    if-eqz v1, :cond_0

    .line 84
    iget-object v1, p0, Lger;->a:Landroid/telecom/RemoteConference;

    check-cast v0, Lgel;

    invoke-virtual {v0}, Lgel;->n()Landroid/telecom/RemoteConnection;
