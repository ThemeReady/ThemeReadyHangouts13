...
.field private final k:Ltl;

.field private final l:Ltl;

.field private final m:Lsk;

.field private final n:Lsk;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/DrawerLayout;->c:Lsd;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0}, Lsc;-><init>(Landroid/support/v4/widget/DrawerLayout;)V

    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->e:Lsc;
    ...
    invoke-direct {v2, p0, v3}, Lsk;-><init>(Landroid/support/v4/widget/DrawerLayout;I)V

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Lsk;
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->n:Lsk;

    .line 385
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Lsk;

    invoke-static {p0, v5, v2}, Ltl;->a(Landroid/view/ViewGroup;FLto;)Ltl;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Ltl;

    .line 386
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Ltl;

    invoke-virtual {v2, v4}, Ltl;->a(I)V

    .line 387
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Ltl;

    invoke-virtual {v2, v1}, Ltl;->a(F)V

    .line 388
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Lsk;

    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->k:Ltl;

    invoke-virtual {v2, v3}, Lsk;->a(Ltl;)V

    .line 390
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->n:Lsk;

    invoke-static {p0, v5, v2}, Ltl;->a(Landroid/view/ViewGroup;FLto;)Ltl;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Ltl;

    .line 391
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Ltl;

    const/4 v3, 0x2

    invoke-virtual {v2, v3}, Ltl;->a(I)V
    ...
    .line 393
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->n:Lsk;

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Ltl;

    invoke-virtual {v1, v2}, Lsk;->a(Ltl;)V
    ...
    invoke-direct {v1, p0}, Lsb;-><init>(Landroid/support/v4/widget/DrawerLayout;)V

    invoke-static {p0, v1}, Loa;->a(Landroid/view/View;Llt;)V

    .line 3199
    sget-object v1, Loq;->a:Los;

    const/4 v2, 0x0

    invoke-virtual {v1, p0, v2}, Los;->a(Landroid/view/ViewGroup;Z)V
    ...
    .line 404
    sget-object v1, Landroid/support/v4/widget/DrawerLayout;->c:Lsd;

    invoke-interface {v1, p0}, Lsd;->a(Landroid/view/View;)V

    .line 405
    sget-object v1, Landroid/support/v4/widget/DrawerLayout;->c:Lsd;

    invoke-interface {v1, p1}, Lsd;->a(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
...
.method private static a(Landroid/graphics/drawable/Drawable;I)Z
    ...
    invoke-static {p0}, Ljb;->b(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 1178
    :cond_1
    invoke-static {p0, p1}, Ljb;->b(Landroid/graphics/drawable/Drawable;I)Z
...
.method private c(Landroid/view/View;Z)V
    ...
    invoke-static {v2, v3}, Loa;->c(Landroid/view/View;I)V
...
.method public a(II)V
    ...
    .line 620
    invoke-static {p2, v0}, Lmj;->a(II)I
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->k:Ltl;
    ...
    .line 640
    :cond_2
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->l:Ltl;
...
.method public a(ILandroid/view/View;)V
    ...
    invoke-virtual {v2}, Ltl;->a()I

    move-result v2

    .line 806
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->l:Ltl;

    invoke-virtual {v3}, Ltl;->a()I
    ...
    invoke-interface {v0, v2}, Lsg;->a(I)V
...
.method a(Landroid/view/View;F)V
    ...
    invoke-interface {v0, p1, p2}, Lsg;->a(Landroid/view/View;F)V
...
.method public a(Landroid/view/View;Z)V
    ...
    invoke-virtual {v0, p1, v2, v1}, Ltl;->a(Landroid/view/View;II)Z
    ...
    .line 1623
    invoke-virtual {v0, p1, v1, v2}, Ltl;->a(Landroid/view/View;II)Z
...
.method public a(Lsg;)V
    ...
    .prologue
    .line 537
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->x:Lsg;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/widget/DrawerLayout;->c(Lsg;)V
    ...
    .line 541
    invoke-virtual {p0, p1}, Landroid/support/v4/widget/DrawerLayout;->b(Lsg;)V

    .line 545
    :cond_1
    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->x:Lsg;
...
.method a(Z)V
    ...
    .line 1573
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->k:Ltl;
    ...
    .line 1573
    invoke-virtual {v7, v5, v6, v8}, Ltl;->a(Landroid/view/View;II)Z
    ...
    .line 1576
    :cond_2
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->l:Ltl;
    ...
    .line 1576
    invoke-virtual {v6, v5, v7, v8}, Ltl;->a(Landroid/view/View;II)Z
    ...
    .line 1583
    :cond_3
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->m:Lsk;

    invoke-virtual {v0}, Lsk;->a()V

    .line 1584
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->n:Lsk;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-static {p1, v0}, Loa;->c(Landroid/view/View;I)V
    ...
    .line 1994
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->e:Lsc;

    invoke-static {p1, v0}, Loa;->a(Landroid/view/View;Llt;)V
...
.method b(Landroid/view/View;)V
    ...
    invoke-interface {v0, p1}, Lsg;->b(Landroid/view/View;)V
...
.method public c(I)Ljava/lang/CharSequence;
    ...
    .line 790
    invoke-static {p1, v0}, Lmj;->a(II)I
...
.method c(Landroid/view/View;)V
    ...
    invoke-interface {v0, p1}, Lsg;->a(Landroid/view/View;)V
...
.method public computeScroll()V
    ...
    invoke-virtual {v0, v4}, Ltl;->a(Z)Z

    move-result v0

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->l:Ltl;

    invoke-virtual {v1, v4}, Ltl;->a(Z)Z
...
.method public e(Landroid/view/View;)I
    ...
    invoke-static {v0, v1}, Lmj;->a(II)I
...
.method public g(Landroid/view/View;)Z
    ...
    .line 1426
    invoke-static {v0, v2}, Lmj;->a(II)I
...
.method protected generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, p1}, Lsh;-><init>(Landroid/view/ViewGroup$MarginLayoutParams;)V
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 1348
    sget-object v0, Landroid/support/v4/widget/DrawerLayout;->c:Lsd;

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->G:Ljava/lang/Object;

    invoke-interface {v0, v1}, Lsd;->a(Ljava/lang/Object;)I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v3, p1}, Ltl;->a(Landroid/view/MotionEvent;)Z

    move-result v3

    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->l:Ltl;

    .line 1445
    invoke-virtual {v4, p1}, Ltl;->a(Landroid/view/MotionEvent;)Z
    ...
    .line 1456
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->k:Ltl;

    float-to-int v0, v0

    float-to-int v4, v4

    invoke-virtual {v5, v0, v4}, Ltl;->b(II)Landroid/view/View;
    ...
    invoke-virtual {v0, v4}, Ltl;->c(I)Z
...
.method protected onLayout(ZIIII)V
    ...
    .line 1197
    iget v1, v0, Lsh;->leftMargin:I

    iget v2, v0, Lsh;->topMargin:I
    ...
    .line 1228
    iget v10, v0, Lsh;->bottomMargin:I
    ...
    iget v11, v0, Lsh;->bottomMargin:I
    ...
    iget v13, v0, Lsh;->bottomMargin:I
...
.method protected onMeasure(II)V
    ...
    invoke-static {v6, v8}, Lmj;->a(II)I

    move-result v6

    .line 1072
    invoke-static {v10}, Loa;->p(Landroid/view/View;)Z
    ...
    .line 1073
    sget-object v11, Landroid/support/v4/widget/DrawerLayout;->c:Lsd;

    iget-object v12, p0, Landroid/support/v4/widget/DrawerLayout;->G:Ljava/lang/Object;

    invoke-interface {v11, v10, v12, v6}, Lsd;->a(Landroid/view/View;Ljava/lang/Object;I)V
    ...
    .line 1081
    iget v6, v0, Lsh;->leftMargin:I

    sub-int v6, v2, v6

    iget v11, v0, Lsh;->rightMargin:I
    ...
    invoke-interface {v11, v0, v12, v6}, Lsd;->a(Landroid/view/ViewGroup$MarginLayoutParams;Ljava/lang/Object;I)V
    ...
    .line 12901
    sget-object v6, Loa;->a:Loj;

    invoke-virtual {v6, v10}, Loj;->B(Landroid/view/View;)F
    ...
    invoke-static {v10, v6}, Loa;->f(Landroid/view/View;F)V
    ...
    iget v12, v0, Lsh;->bottomMargin:I

    add-int/2addr v11, v12

    iget v0, v0, Lsh;->height:I
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v6, v0}, Lsi;-><init>(Landroid/os/Parcelable;)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p1}, Ltl;->b(Landroid/view/MotionEvent;)V
    ...
    .line 1509
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->k:Ltl;

    float-to-int v5, v0

    float-to-int v6, v3

    invoke-virtual {v4, v5, v6}, Ltl;->b(II)Landroid/view/View;
