...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    .prologue
    .line 78
    invoke-direct {p0, p1}, Liry;-><init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lirq;->h:Ljava/util/Set;

    .line 79
    iput-object p1, p0, Lirq;->G:Landroid/content/Context;

    .line 80
    iput-boolean p2, p0, Lirq;->g:Z
    ...
    iput-object v0, p0, Lirq;->s:Litr;

    .line 82
    new-instance v0, Lirt;

    invoke-direct {v0, p0}, Lirt;-><init>(Lirq;)V

    iput-object v0, p0, Lirq;->F:Lirt;

    .line 83
    new-instance v0, Liru;

    invoke-direct {v0, p0}, Liru;-><init>(Lirq;)V
    ...
    invoke-direct {v0, p0}, Lirs;-><init>(Lirq;)V

    iput-object v0, p0, Lirq;->c:Lirs;

    .line 85
    new-instance v0, Lirv;

    invoke-direct {v0, p0}, Lirv;-><init>(Lirq;)V

    iput-object v0, p0, Lirq;->d:Lirv;

    .line 86
    new-instance v0, Lirw;

    invoke-direct {v0, p0}, Lirw;-><init>(Lirq;)V

    iput-object v0, p0, Lirq;->e:Lirw;

    .line 87
    new-instance v0, Lirx;

    invoke-direct {v0, p0}, Lirx;-><init>(Lirq;)V

    iput-object v0, p0, Lirq;->f:Lirx;
    ...
    iput-object v0, p0, Lirq;->a:Landroid/hardware/camera2/CameraManager;

    .line 89
    invoke-direct {p0}, Lirq;->p()V
...
.method private p()V
    ...
    .line 228
    :try_start_0
    iget-object v0, p0, Lirq;->a:Landroid/hardware/camera2/CameraManager;
    ...
    .line 231
    iput-object v4, p0, Lirq;->k:Ljava/lang/String;
    ...
    .line 233
    :cond_0
    iput-object v4, p0, Lirq;->l:Ljava/lang/String;
    :try_end_0
    .catch Landroid/hardware/camera2/CameraAccessException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public a(Lite;)V
    ...
    .prologue
    .line 109
    invoke-super {p0, p1}, Liry;->a(Lite;)V

    .line 110
    const/4 v0, 0x0

    iput-object v0, p0, Lirq;->j:Lijn;
...
.method public a(Lite;Litq;)V
    ...
    .prologue
    .line 95
    invoke-super {p0, p1, p2}, Liry;->a(Lite;Litq;)V
    ...
    iput-object p1, p0, Lirq;->j:Lijn;

    .line 98
    iget-boolean v0, p0, Lirq;->g:Z

    if-eqz v0, :cond_0

    .line 99
    iget-object v0, p0, Lirq;->G:Landroid/content/Context;

    invoke-static {v0}, Lirq;->b(Landroid/content/Context;)I

    move-result v0

    invoke-interface {p2, v0}, Litq;->b(I)V
    ...
    .line 102
    iget-object v0, p0, Lirq;->s:Litr;

    invoke-interface {p2, v0}, Litq;->a(Litr;)V

    .line 103
    iget-boolean v0, p0, Lirq;->x:Z

    invoke-virtual {p0, v0}, Lirq;->a(Z)V
...
.method public a()Z
    ...
    .prologue
    .line 162
    iget-object v0, p0, Lirq;->k:Ljava/lang/String;
...
.method public b()Z
    ...
    .prologue
    .line 170
    iget-object v0, p0, Lirq;->l:Ljava/lang/String;
...
.method protected c()Liuc;
    .locals 2

    .prologue
    .line 175
    iget-object v1, p0, Lirq;->y:Ljava/lang/Object;

    monitor-enter v1

    .line 176
    :try_start_0
    iget-object v0, p0, Lirq;->o:Liuc;
...
.method protected d()V
    ...
    :try_start_1
    iput-boolean v0, p0, Lirq;->H:Z

    .line 259
    iget-object v0, p0, Lirq;->m:Landroid/hardware/camera2/CameraDevice;
    ...
    :cond_4
    :try_start_2
    iget-object v2, p0, Lirq;->a:Landroid/hardware/camera2/CameraManager;

    iget-object v3, p0, Lirq;->F:Lirt;

    iget-object v4, p0, Lirq;->v:Landroid/os/Handler;
...
.method protected e()V
    ...
    .line 281
    :try_start_0
    iget-object v0, p0, Lirq;->n:Landroid/hardware/camera2/CameraCaptureSession;
    ...
    iget-object v5, p0, Lirq;->n:Landroid/hardware/camera2/CameraCaptureSession;
    ...
    invoke-static {v4, v0, v2, v3}, Litx;->a(ILjava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    iput-object v0, p0, Lirq;->n:Landroid/hardware/camera2/CameraCaptureSession;
    ...
    iput-object v0, p0, Lirq;->m:Landroid/hardware/camera2/CameraDevice;

    .line 293
    :cond_1
    iget-object v0, p0, Lirq;->i:Landroid/view/Surface;
    ...
    .line 297
    :cond_2
    iget-object v0, p0, Lirq;->h:Ljava/util/Set;
...
.method f()Liuc;
    ...
    .line 190
    :try_start_1
    iget-object v1, p0, Lirq;->a:Landroid/hardware/camera2/CameraManager;
    ...
    .line 194
    iget-object v1, p0, Lirq;->B:Liuc;

    new-instance v2, Liuc;

    iget-object v3, p0, Lirq;->z:Lits;

    iget v3, v3, Lits;->d:I

    iget-object v4, p0, Lirq;->z:Lits;

    iget v4, v4, Lits;->e:I

    invoke-direct {v2, v3, v4}, Liuc;-><init>(II)V

    invoke-static {v1, v2}, Liuc;->a(Liuc;Liuc;)Liuc;
    ...
    invoke-static {v11, v0, v4, v10}, Litx;->a(ILjava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {v0, v6, v6}, Liuc;-><init>(II)V
