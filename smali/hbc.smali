...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-object p1, p0, Lhbc;->d:Landroid/content/Context;

    new-instance v0, Lhbf;

    iget-object v1, p0, Lhbc;->d:Landroid/content/Context;

    invoke-direct {v0, v1}, Lhbf;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lhbc;->f:Lhbf;
    ...
    invoke-direct/range {v0 .. v5}, Lhha;-><init>(Landroid/content/Context;IZZLjava/lang/String;)V

    .line 0
    :goto_0
    iput-object v0, p0, Lhbc;->c:Ljavax/net/ssl/SSLSocketFactory;

    iget-object v0, p0, Lhbc;->c:Ljavax/net/ssl/SSLSocketFactory;
    ...
    .line 0
    iput-object v0, p0, Lhbc;->e:Ljavax/net/ssl/HostnameVerifier;
...
.method public a(Ljava/net/URL;Landroid/net/Network;)Ljava/net/HttpURLConnection;
    ...
    iget-object v0, p0, Lhbc;->f:Lhbf;

    invoke-virtual {p1}, Ljava/net/URL;->toString()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lhbf;->a(Ljava/lang/String;)Landroid/os/Bundle;
    ...
    invoke-direct {v1, v0}, Lawx;-><init>(Landroid/os/Bundle;)V
    ...
    iget-object v2, p0, Lhbc;->c:Ljavax/net/ssl/SSLSocketFactory;

    invoke-virtual {v0, v2}, Ljavax/net/ssl/HttpsURLConnection;->setSSLSocketFactory(Ljavax/net/ssl/SSLSocketFactory;)V

    :cond_4
    iget-object v0, p0, Lhbc;->e:Ljavax/net/ssl/HostnameVerifier;
    ...
    iget-object v2, p0, Lhbc;->e:Ljavax/net/ssl/HostnameVerifier;
    ...
    :cond_6
    iget-object v0, p0, Lhbc;->d:Landroid/content/Context;
...
.method a(Ljava/lang/String;I)V
    ...
    invoke-virtual {v0, p1, p2}, Lhbf;->a(Ljava/lang/String;I)V
