...
.method protected a(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lest;->g()Ljava/lang/String;
...
.method public b(Landroid/content/Context;Leaf;)Levz;
    ...
    :cond_0
    :goto_0
    invoke-virtual {p0, p1}, Lest;->b(Landroid/content/Context;)Lcom/google/api/client/http/GenericUrl;

    move-result-object v0

    .line 1068
    invoke-virtual {p0}, Lest;->m()V

    .line 1069
    new-instance v2, Ljava/io/File;

    iget-object v3, p0, Lest;->b:Ljava/lang/String;
    ...
    invoke-direct {v7, v8}, Lotl;-><init>(Ljava/lang/String;)V

    invoke-virtual {v0, v6, v7}, Loti;->a(Ljava/lang/String;Lotj;)V
    ...
    iget-object v8, p0, Lest;->i:Lgmp;

    .line 1092
    invoke-interface {v8}, Lgmp;->c()Ljava/lang/String;
    ...
    invoke-direct {v7, v3}, Lotl;-><init>(Ljava/lang/String;)V
    ...
    new-instance v6, Lotl;

    const-string v7, "log"

    invoke-direct {v6, v7}, Lotl;-><init>(Ljava/lang/String;)V

    invoke-virtual {v0, v3, v6}, Loti;->a(Ljava/lang/String;Lotj;)V
    ...
    invoke-direct {v6, v2}, Lotk;-><init>(Ljava/io/File;)V
    ...
    invoke-direct {v0, v2, v1}, Lfdo;-><init>(ILjava/lang/Exception;)V
