...
# direct methods
.method constructor <init>(Lhec;Ljava/util/List;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, Liau;->a:Ljava/util/List;
...
.method public a(Lcom/google/android/gms/wearable/internal/PutDataResponse;)V
    ...
    invoke-direct {v0, v1, v2}, Lhxr;-><init>(Lcom/google/android/gms/common/api/Status;Lhxw;)V

    invoke-virtual {p0, v0}, Liau;->a(Ljava/lang/Object;)V

    iget v0, p1, Lcom/google/android/gms/wearable/internal/PutDataResponse;->b:I

    if-eqz v0, :cond_0

    iget-object v0, p0, Liau;->a:Ljava/util/List;
