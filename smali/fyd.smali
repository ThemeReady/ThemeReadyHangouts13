...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lfyd;->b:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    sput-object v0, Lfyd;->c:Landroid/net/Uri;
...
.method public constructor <init>(Landroid/telephony/SmsManager;)V
    ...
    iput-object v0, p0, Lfyd;->e:Ljava/util/concurrent/ConcurrentHashMap;

    .line 46
    iput-object p1, p0, Lfyd;->d:Landroid/telephony/SmsManager;

    .line 47
    return-void
.end method

.method private a(Landroid/content/Context;Ljava/lang/String;Laid;Z)Laiu;
    .locals 14
    ...
    invoke-virtual {p0, p1, v0}, Lfyd;->a(Landroid/content/Context;Laid;)Landroid/net/Uri;
    ...
    invoke-direct {v6, v2, v0}, Lfye;-><init>(Landroid/net/Uri;Z)V

    .line 132
    sget-object v3, Lfyd;->b:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    .line 138
    :try_start_0
    iget-object v3, p0, Lfyd;->e:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 141
    sget-object v3, Lfyd;->c:Landroid/net/Uri;
    ...
    invoke-virtual {p0, p1, v2, v0, v4}, Lfyd;->a(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Landroid/content/Intent;)V

    .line 147
    const-class v2, Lbiw;

    invoke-static {p1, v2}, Ljyn;->a(Landroid/content/Context;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-interface {v2, v3, v4, v5}, Lbiw;->a(Ljava/lang/String;J)J
    ...
    invoke-static {v2, v3, v7}, Lglk;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    :cond_1
    :try_start_3
    iget-object v2, p0, Lfyd;->e:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 5299
    :pswitch_0
    iget-object v2, v6, Lfye;->a:Landroid/net/Uri;
    ...
    .line 6299
    iget-object v3, v6, Lfye;->a:Landroid/net/Uri;
    ...
    .line 7299
    :cond_5
    iget-boolean v2, v6, Lfye;->b:Z

    .line 2215
    if-eqz v2, :cond_6

    .line 8299
    iget-object v2, v6, Lfye;->e:[B

    .line 2217
    invoke-virtual {p0, v2}, Lfyd;->a([B)Laiu;
    ...
    invoke-direct {v2, v3}, Lfxy;-><init>(I)V
...
# virtual methods
.method public a(Landroid/content/Context;Laiv;)Laiu;
    .locals 2
    ...
    invoke-direct {p0, p1, v0, p2, v1}, Lfyd;->a(Landroid/content/Context;Ljava/lang/String;Laid;Z)Laiu;
...
.method a([B)Laiu;
    ...
    invoke-direct {v0, p1}, Lain;-><init>([B)V
...
.method a(Landroid/content/Context;Laid;)Landroid/net/Uri;
    .locals 6
    ...
    invoke-direct {v2, p1, p2}, Laih;-><init>(Landroid/content/Context;Laid;)V

    invoke-virtual {v2}, Laih;->a()[B
    ...
    :goto_1
    invoke-static {v4, v2, v0}, Lglk;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v0, v2}, Lfyf;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v2, v3, v0}, Lfxy;-><init>(ILjava/lang/Throwable;)V
...
.method public a(JII[B)V
    ...
    .line 72
    iget-object v0, p0, Lfyd;->e:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 75
    :try_start_0
    invoke-virtual {v0, p3, p4, p5}, Lfye;->a(II[B)V
...
.method a(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Landroid/content/Intent;)V
    ...
    .line 231
    iget-object v0, p0, Lfyd;->d:Landroid/telephony/SmsManager;

    .line 8433
    sget-object v4, Lfxt;->b:Landroid/os/Bundle;
...
.method public a(Landroid/content/Context;[BLjava/lang/String;I)V
    ...
    invoke-direct {v0, v1, p2, v2}, Laid;-><init>(I[BI)V

    .line 112
    const/4 v1, 0x0

    invoke-direct {p0, p1, p3, v0, v1}, Lfyd;->a(Landroid/content/Context;Ljava/lang/String;Laid;Z)Laiu;
