...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lgst;->c:Ljava/lang/String;

    sget v0, Landroid/os/Build$VERSION;->SDK_INT:I

    const-string v0, "androidPackageName"

    sput-object v0, Lgst;->d:Ljava/lang/String;
    ...
    sput-object v0, Lgst;->e:Landroid/content/ComponentName;
    ...
    sput-object v0, Lgst;->a:Landroid/content/ComponentName;

    return-void
.end method

.method static a(Landroid/content/Context;Landroid/content/ComponentName;Lgsw;)Ljava/lang/Object;
    .locals 5
    ...
    invoke-static {p0}, Lgwj;->a(Landroid/content/Context;)Lgwj;

    move-result-object v2

    const-string v0, "GoogleAuthUtil"

    invoke-virtual {v2, p1, v1, v0}, Lgwj;->a(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)Z
    ...
    :try_start_0
    invoke-virtual {v1}, Lgxv;->a()Landroid/os/IBinder;

    move-result-object v0

    invoke-interface {p2, v0}, Lgsw;->a(Landroid/os/IBinder;)Ljava/lang/Object;
    :try_end_0
    ...
    invoke-virtual {v2, p1, v1, v3}, Lgwj;->b(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)V
...
.method static a(Landroid/content/Context;)V
    ...
    invoke-direct {v1, v2, v3, v0}, Lgsx;-><init>(ILjava/lang/String;Landroid/content/Intent;)V
    ...
    invoke-virtual {v0}, Lgtr;->getMessage()Ljava/lang/String;

    move-result-object v0

    invoke-direct {v1, v0}, Lgsr;-><init>(Ljava/lang/String;)V
...
.method public static b(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/android/gms/auth/TokenData;
    ...
    invoke-static {p2, v0}, Lgwb;->a(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-direct {v1, p1, p2, v0}, Lgsu;-><init>(Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)V
