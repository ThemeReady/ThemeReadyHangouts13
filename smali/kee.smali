...
# instance fields
.field final transient a:Lkdz;


# direct methods
.method private constructor <init>(Lcom/google/api/client/http/HttpResponseException$Builder;Lkdz;)V
    .locals 0
    ...
    .line 56
    iput-object p2, p0, Lkee;->a:Lkdz;

    .line 57
    return-void
.end method

.method public static a(Lcom/google/api/client/json/JsonFactory;Lcom/google/api/client/http/HttpResponse;)Lkee;
    .locals 7
    ...
    .line 90
    :try_start_1
    invoke-virtual {v0}, Lkdz;->toPrettyString()Ljava/lang/String;
    :try_end_1
    ...
    .line 100
    invoke-static {v0}, Lgwb;->ag(Ljava/lang/String;)Z
    ...
    invoke-direct {v0, v3, v1}, Lkee;-><init>(Lcom/google/api/client/http/HttpResponseException$Builder;Lkdz;)V
