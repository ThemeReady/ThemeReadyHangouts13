...
# direct methods
.method public constructor <init>(Lcom/google/android/libraries/material/progress/MaterialProgressBar;Livp;)V
    .locals 0

    .prologue
    .line 416
    iput-object p1, p0, Livs;->b:Lcom/google/android/libraries/material/progress/MaterialProgressBar;

    iput-object p2, p0, Livs;->a:Livp;
...
.method public run()V
    ...
    .line 419
    iget-object v0, p0, Livs;->b:Lcom/google/android/libraries/material/progress/MaterialProgressBar;

    .line 1028
    iput-boolean v2, v0, Lcom/google/android/libraries/material/progress/MaterialProgressBar;->a:Z

    .line 420
    iget-object v0, p0, Livs;->a:Livp;

    invoke-virtual {v0}, Livp;->isVisible()Z
    ...
    invoke-virtual {v3}, Livp;->getGrowScale()F
    ...
    .line 433
    iget-object v5, p0, Livs;->b:Lcom/google/android/libraries/material/progress/MaterialProgressBar;
    ...
    .line 437
    iget-object v6, p0, Livs;->b:Lcom/google/android/libraries/material/progress/MaterialProgressBar;
    ...
    .line 442
    invoke-virtual {v0, v1}, Livm;->a(Z)Z

    .line 444
    :cond_1
    invoke-virtual {v0, v3}, Livm;->setGrowScale(F)V

    .line 445
    if-nez v4, :cond_2

    :goto_1
    invoke-virtual {v0, v1, v2}, Livm;->setVisible(ZZ)Z

    .line 446
    iget-object v0, p0, Livs;->a:Livp;

    invoke-virtual {v0, v2}, Livp;->a(Z)Z
