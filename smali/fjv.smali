...
.method public a(Landroid/content/Context;Leaf;)V
    ...
    .line 76
    :try_start_0
    iget-object v0, p0, Lfjv;->b:Lfjw;

    .line 79
    invoke-virtual {v0}, Lfjw;->f()Ljava/lang/String;
    ...
    .line 80
    invoke-virtual {v0}, Lfjw;->g()Ljava/lang/String;
    ...
    .line 81
    invoke-virtual {v0}, Lfjw;->i()Ljava/lang/String;
    ...
    .line 77
    invoke-static/range {v1 .. v7}, Lfyz;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZJ)Lfza;
    ...
    .line 86
    invoke-virtual {v0}, Lfza;->b()I

    move-result v0

    .line 87
    sget-boolean v1, Lfjv;->a:Z
    ...
    :try_end_0
    .catch Lfyr; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 93
    invoke-static/range {v1 .. v8}, Lfyi;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;JJZ)Landroid/net/Uri;
    ...
    .line 106
    invoke-static {v1}, Lfyi;->c(Landroid/net/Uri;)J

    move-result-wide v2

    .line 105
    invoke-static {v0, v2, v3}, Lfzb;->a(IJ)V

    .line 110
    :goto_2
    new-instance v0, Lezn;

    iget-object v2, p0, Lfjv;->b:Lfjw;

    invoke-virtual {v2}, Lfjw;->c()J

    move-result-wide v2

    invoke-direct {v0, v1, v2, v3}, Lezn;-><init>(Landroid/net/Uri;J)V
    :try_end_1
    .catch Lfyr; {:try_start_1 .. :try_end_1} :catch_0
    ...
    throw v0
    :try_end_2
    .catch Lfyr; {:try_start_2 .. :try_end_2} :catch_0
    ...
    invoke-virtual {v0, v4, v5}, Lezn;->a(J)V
    ...
    invoke-virtual {v0, v2, v3}, Lezn;->b(J)V

    .line 136
    iget-object v1, p0, Lfjv;->b:Lfjw;

    invoke-virtual {v0, v1}, Lezn;->a(Lfok;)V
...
.method public a_(Landroid/content/Context;ILfdo;)V
    ...
    .line 156
    :cond_2
    iget-object v3, p0, Lfjv;->b:Lfjw;

    .line 158
    invoke-virtual {v3}, Lfjw;->e()Ljava/lang/String;

    move-result-object v3

    iget-object v4, p0, Lfjv;->b:Lfjw;

    .line 159
    invoke-virtual {v4}, Lfjw;->d()Ljava/lang/String;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lfjw;->toString()Ljava/lang/String;
